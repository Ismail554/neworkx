class AppStrings {
  ...
  static const String detailsJobDescription =
      "Telegram is a popular, free, cloud-based instant messaging app known for its focus on speed, security, and privacy, allowing users to exchange messages, photos, videos, and files across multiple devices. Key features include large group chats, channels for broadcasting to unlimited audiences.";
